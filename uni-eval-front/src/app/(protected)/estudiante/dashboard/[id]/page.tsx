  ...
  return (
    <div className="">
      <main className="container mx-auto px-3 sm:px-4 md:px-8 py-4 sm:py-8 max-w-7xl">
        ...
        {/* Header */}
        <div className="flex items-start gap-3 sm:gap-4 mb-5 sm:mb-10">
          <div className="w-10 h-10 sm:w-14 sm:h-14 rounded-2xl sm:rounded-3xl bg-gray-900 flex items-center justify-center shadow-lg shrink-0">
